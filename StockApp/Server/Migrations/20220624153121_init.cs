    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CachedStocks", x => x.Symbol);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tickers_CachedStocks_StockSymbol",
                        column: x => x.StockSymbol,
                        principalTable: "CachedStocks",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserStocks", x => new { x.ApplicationUserId, x.Symbol });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserStocks_CachedStocks_Symbol",
                        column: x => x.Symbol,
                        principalTable: "CachedStocks",
                        principalColumn: "Symbol",
                        onDelete: ReferentialAction.Cascade);
